...
#		$ python postHitSandbox.py ../experiments/jdf/e8_singleIdentity_memory_association_oneFuture/turkHitParams.py
#
# 3. to post to "actual" MTURK, open the terminal and run these commands
# 		$ cd /Volumes/turk/boto
#		$ python postHitActual.py ../experiments/jdf/e8_singleIdentity_memory_association_oneFuture/turkHitParams.py

# alvarezlab, konklab
lab = "defreitas"
# Describe your Hit to Workers
titleForWorkers = "Image Judgment"
descriptionForWorkers = "React quickly to briefly presented shapes. Takes roughly 10 min. Please only participate if you have normal or corrected-to-normal vision, and haven't done image judgment before."
keywordsForWorkers = ["short","fun","easy"]

# title for you (workers don't see this, but you will in the "manage hits" interface)
projectNameForRequesters = "jdf-singleIdentity-e8-memory-association"
...
pay = 1.00	
numAssignmentsToPost = 150 # turk calls this "Number of assignments per HIT"
...
# Design Layout
urlForHIT = "https://scorsese.wjh.harvard.edu/turk/experiments/jdf/e8_singleIdentity_memory_association_oneFuture/landingPage.html"
frameHeight = 675
