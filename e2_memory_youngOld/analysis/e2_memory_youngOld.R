...
dir <- setwd("/Users/julian/Documents/github/juliandefreitas/self/memory_distinct_selves/e2_memory_youngOld/data")
...
annotate_figure(figure,top = text_grob("Experiment 2: Past and Future Selves", face = "bold", size = 27),
