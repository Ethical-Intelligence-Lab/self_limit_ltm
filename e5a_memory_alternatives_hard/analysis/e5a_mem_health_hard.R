...
dir <- setwd("/Users/julian/Documents/github/juliandefreitas/self/memory_distinct_selves/e5a_memory_alternatives_hard/data")
...
annotate_figure(figure,top = text_grob("Experiment 5a: Similar Alternate Selves", face = "bold", size = 27),
