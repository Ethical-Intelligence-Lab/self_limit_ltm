...
#		$ python postHitSandbox.py ../experiments/jdf/e16_memory_youngOld_hard_v3/turkHitParams.py
#
# 3. to post to "actual" MTURK, open the terminal and run these commands
# 		$ cd /Volumes/turk/boto
#		$ python postHitActual.py ../experiments/jdf/e16_memory_youngOld_hard_v3/turkHitParams.py

# alvarezlab, konklab
lab = "defreitas"
# Describe your Hit to Workers
titleForWorkers = "Duplication Judgment"
descriptionForWorkers = "Make simple judgments about images. Takes around 10 min. Please only participate if you have normal or corrected-to-normal vision, and if you haven't done Duplication Judgment before"
keywordsForWorkers = ["short","fun","easy"]

# title for you (workers don't see this, but you will in the "manage hits" interface)
projectNameForRequesters = "jdf-singleIdentity-e16-memory-youngOld-hard-v3"
...
pay = 1.00	
numAssignmentsToPost = 50 # turk calls this "Number of assignments per HIT"
...
# Design Layout
urlForHIT = "https://scorsese.wjh.harvard.edu/turk/experiments/jdf/e16_memory_youngOld_hard_v3/landingPage.html"
frameHeight = 675
