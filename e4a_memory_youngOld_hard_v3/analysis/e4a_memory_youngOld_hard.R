...
dir <- setwd("/Users/julian/Documents/github/juliandefreitas/self/memory_distinct_selves/e4a_memory_youngOld_hard_v3/data")
...
sex <- as.factor(data$sex); table(sex)[2]/sum(table(sex)) 
...
annotate_figure(figure,top = text_grob("Experiment 4a: Similar Past and Future Selves", face = "bold", size = 27),
