...
dir <- setwd("/Users/julian/Dropbox (Personal)/Research/Intuition/single_identity/e15_memory_youngOld_easy/data")
...
head(data)
dim(data)
length(unique(data$workerId)) #102 subjects
...
#compare pref_easy to pref_hard, from e14
