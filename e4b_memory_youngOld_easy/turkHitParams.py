...
#		$ python postHitSandbox.py ../experiments/jdf/e16_memory_youngOld_hard/turkHitParams.py
#
# 3. to post to "actual" MTURK, open the terminal and run these commands
# 		$ cd /Volumes/turk/boto
#		$ python postHitActual.py ../experiments/jdf/e16_memory_youngOld_hard/turkHitParams.py
...
projectNameForRequesters = "jdf-singleIdentity-e16-memory-youngOld-hard"
...
# Design Layout
urlForHIT = "https://scorsese.wjh.harvard.edu/turk/experiments/jdf/e16_memory_youngOld_hard/landingPage.html"
frameHeight = 675
